...
class RoverFrame(wx.Frame):
	def __init__(self, *args, **kwds):
		...
		self.button_take_control = wx.ToggleButton(self, wx.ID_ANY, _("Take control"))
		...
		self.panel_videofeed = wx.Panel(self, wx.ID_ANY)
		...
		self.textctrl_command = wx.TextCtrl(self, wx.ID_ANY, "")
	...
	def __set_properties(self):
		...
		self.panel_videofeed.SetMinSize((800, 600))
		self.panel_videofeed.SetBackgroundColour(wx.Colour(186, 186, 186))
		# end wxGlade
	...
	def __do_layout(self):
		...
		gridsizer_connection_actions.Add(self.label_connection_status, 0, 0, 0)
		...
		sizer_feedconsole.Add(self.panel_videofeed, 4, wx.EXPAND | wx.FIXED_MINSIZE, 0)
		sizer_feedconsole.Add(self.textctrl_console, 1, wx.EXPAND, 0)
		sizer_command.Add(self.textctrl_command, 2, wx.EXPAND, 0)
